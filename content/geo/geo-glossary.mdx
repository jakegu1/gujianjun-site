...
本文就是帮大家解决这个问题的。我把 GEO 相关的核心术语整理成了一份手册，按英文字母排序，每个词都用大白话作简单清晰的解释，然后带上实际使用场景。不管你是刚入门的 GEO 新手，还是做了几年 SEO 正在转型的老手，遇到不懂的词回来查就行。
...
如果你还不太了解 GEO 的整体概念，建议先看站内这篇文章[《GEO 是什么》](/geo/what-is-geo/)，再回来查术语。
